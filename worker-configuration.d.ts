/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7b31ccbd6f2fbcda02b42928ba57c81f)
// Runtime types generated with workerd@1.20260310.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		planmd_db: D1Database;
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "DEV_BYPASS_AUTH" | "VITE_DEV_BYPASS_AUTH">> {}
}
